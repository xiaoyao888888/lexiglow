...
另外，单词级 tooltip 现在也加入了更贴近词典使用习惯的发音能力：

- 英音 / 美音分开展示
- 支持音标显示
- 点击小喇叭即可播放发音
- 当前优先使用本机更稳定的系统语音，避免免费音频源带来的忽大忽小或音质不稳
...
对很多用户来说，知道“意思”还不够，真正卡住阅读体验的往往是：

- 这个词会不会读
- 英音和美音差在哪
- 我是不是一直把重音念错了

所以现在在单词 tooltip 里，你还能直接看到：

- 英音音标
- 美音音标
- 对应的小喇叭播放按钮

当前实现策略不是盲目追求“免费音频源一定更好”，而是优先选择质量更稳定的系统发音，再保留其他能力作为后续扩展空间。这样做的目标很明确：先保证你点一下，听到的是清楚、稳定、可用的发音。
...
- 播放层：
  - 默认优先系统语音
  - 优先选择更稳定、可听清的英式 / 美式 voice
  - 避开明显的特效 voice

这样设计的原因很现实：

- 免费词典音频源质量并不总是稳定
- 不同网页环境里，最重要的是“点了就能稳定听清”
- 对插件来说，稳定可用往往比理论上更丰富的音源更重要
